...
var b2Pair = exports = Class(function() {
	...
	this.b2_nullPair = b2Settings.USHRT_MAX;
	this.b2_nullProxy = b2Settings.USHRT_MAX;
	this.b2_tableCapacity = b2Settings.b2_maxPairs;
	this.b2_tableMask = this.b2_tableCapacity - 1;
	this.e_pairBuffered = 0x0001;
	this.e_pairRemoved = 0x0002;
	this.e_pairFinal = 0x0004;
});
