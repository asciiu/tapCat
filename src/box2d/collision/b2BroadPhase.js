...
var b2BroadPhase = exports = Class(function( {
	this.init = function(worldAABB, callback){
		...
		this.s_validate = false;
		this.b2_invalid = b2Settings.USHRT_MAX;
		this.b2_nullEdge = b2Settings.USHRT_MAX;
...
//private:
	...
	this.BinarySearch = function(bounds, count, value)
	{
		var low = 0;
		var high = count - 1;
		while (low <= high)
