...
var b2Collision = exports = Class(function() {
	...
	this.EdgeSeparation = function(poly1, edge1, poly2) {
	...
	this.FindMaxSeparation = function(edgeIndex /*int ptr*/, poly1, poly2, conservative){
	...
	this.FindIncidentEdge = function(c, poly1, edge1, poly2){
		var count1 = poly1.m_vertexCount;
		var vert1s = poly1.m_vertices;
		var count2 = poly2.m_vertexCount;
		var vert2s = poly2.m_vertices;
	...
	this.b2CollidePolyTempVec = new b2Vec2();

	this.b2CollidePoly = function(manifold, polyA, polyB, conservative) {
	...
	this.b2CollideCircle = function(manifold, circle1, circle2, conservative){
		manifold.pointCount = 0;
	...
	this.b2CollidePolyAndCircle = function(manifold, poly, circle, conservative){
		manifold.pointCount = 0;
		var tPoint;
	...
	this.b2TestOverlap = function(a, b){
		var t1 = b.minVertex;
		var t2 = a.maxVertex;
